...
* **Тест 4: Перемещение игрока влево** (Позитивный)
    ...
    * Ожидаемый результат: Позиция игрока станет (x - 1, y)
* **Тест 5: Попытка перемещения игрока за пределы игрового поля (верхняя граница)** (Негативный)
...
* **Тест 4: Попытка добавить рыбу в инвентарь, когда он заполнен** (Негативный)
...
* **Тест 4: Попытка поймать рыбу, которая не находится в текущей позиции курсора** (Негативный)
...
* **Тест 5: Использование наживки** (Позитивный)
